...
function createPostElement(post) {
  ...
  //likeButtonElement. innerText = post.likes.indexOf(currentUser) === -1 ? "🤍" : "❤️";

  //there are two way on how to disable the button: either longer easier understable way or one line
  if (currentUser) {
...
/*
<article class="post">
  <h4 class="padding">Title of the image</h4>
  <img src="img/hamster27.jpg" />
  <div class="padding"><button>🤍</button><span>0 likes</span></div>
</article>
*/
checkLogin();
displayPosts();
